    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="index.php" class="active"><span class="las la-radiation"></span><span>Chassis with engine</span></a>
                </li>
                <li>
                    <a href="..\private\index.php" ><span class="las la-car"></span><span>Private</span></a>
                </li>                
            </ul>
        </div>
    </div>
