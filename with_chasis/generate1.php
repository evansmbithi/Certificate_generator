...
$img = imagecreatefrompng("chasistmp.png");
...
$repeat = str_repeat($no_space, 100);
imagettftext(
    $img,   //image object
    10,     //font size
    0,      //angle
